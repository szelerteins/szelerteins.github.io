  ...
  return (
    <div className="modal" style={{ display: isOpen ? 'flex' : 'none' }}>
      <div className="modal-content" style={{ maxWidth: '700px', width: '90%' }}>
        ...
        {step === 2 && (
          <div>
            <div style={{ marginBottom: '2rem', padding: '1rem', background: 'var(--bg-light)', borderRadius: 'var(--radius-card)' }}>
            ...
            <div style={{ marginBottom: '2rem' }}>
              <h3 style={{ marginBottom: '1rem' }}>Selecciona método de pago</h3>
              <div style={{ display: 'grid', gap: '1rem' }}>
                {['Tarjeta de Crédito', 'Transferencia Bancaria', 'PayPal', 'Efectivo al Recibir'].map(method => (
                  <label key={method} className="payment-option" style={{
                    padding: '1rem',
                    border: `2px solid ${formData.paymentMethod === method ? 'var(--primary-green)' : 'var(--border-thin)'}`,
                    borderRadius: 'var(--radius-card)',
                    cursor: 'pointer',
                    background: formData.paymentMethod === method ? 'rgba(16, 185, 129, 0.1)' : 'transparent'
                  }}>
                    <input
                      type="radio"
                      name="paymentMethod"
